...
class Theme extends \App\Entities\Theme implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'tema', 'answers', 'posts'];
        }
     ...
     * {@inheritDoc}
     */
    public function addPost(\App\Entities\Posting $posting)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPost', [$posting]);

        return parent::addPost($posting);
    }
